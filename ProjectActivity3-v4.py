...
def intro():
    #Additional Feature to the project: Arrays of places, limited only within Philippines. This will check if user starts from a place with lockdown.
...
def interzone(name, age, orig, dest):
    ...
    #Additional Feature: Conditional statements for Age, Vaccine status, Restrictions, etc.
    #Backlogs: enhance/polish logic of conditional statements for age, restrictions.
